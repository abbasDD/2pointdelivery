            ...
            <tr>
                ...
                <td>
                    <button type="button" id="statusButton_{{ $blog->id }}"
                        ...
                        onclick="showStatusDialog({{ $blog->id }}, '{{ $blog->is_active }}')">
                        {{ $blog->is_active == 1 ? 'Active' : 'Inactive' }}
                    </button>
                </td>
                <td><a href="{{ route('admin.blog.edit', $blog->id) }}"><i class="fa fa-edit"></i></a>
                </td>
            </tr>
        @empty
            <tr>
...
<script>
    function showStatusDialog(id, status) {
        ...
        var baseUrl = "{{ url('admin/blog/update-status') }}"; // Use `url()` to get the base part
    ...
    function updateStatus(id) {
        console.log(id);
        var baseUrl = "{{ url('admin/blog/update-status') }}";
