        ...
        @forelse ($prioritySettings as $prioritySetting)
            <tr>
                ...
                <td><a class="btn btn-sm btn-primary"
                        href="{{ route('admin.deliveryConfig.priority.edit', $prioritySetting->id) }}"><i
...
<script>
    function showPriorityStatusDialog(id, status) {
        ...
        var baseUrl = "{{ url('admin/delivery-config/priority/update-status') }}"; // Use `url()` to get the base part
    ...
    function updatePriorityStatus(id) {
        console.log(id);
        var baseUrl = "{{ url('admin/delivery-config/priority/update-status') }}";
