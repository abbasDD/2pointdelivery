    ...
    <form @if (session('original_user_id') == null) action="{{ route('client.update.personal') }}" @endif method="POST"
        ...
        <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender"
                            ...
                            <option value="female"
                                ...
                                Female</option>
                            <option value="other"
                                {{ old('gender', $clientData['gender'] ?? '') == 'other' ? 'selected' : '' }}>
                                Other</option>
                        </select>
                        @error('gender')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="date_of_birth"
                            value="{{ old('date_of_birth', isset($clientData->date_of_birth) ? $clientData->date_of_birth : '') }}"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="tax_id" class="form-label">State ID</label>
                        <input type="text" class="form-control" id="tax_id" name="tax_id"
                            value="{{ old('tax_id', $clientData['tax_id'] ?? '') }}" placeholder="State ID" required>
                        @error('tax_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
