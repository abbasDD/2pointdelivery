        ...
        <div class="progressdiv">
            <ul class="progressbar p-0">
                ...
                <li {{ $booking->status == 'pending' ? 'class=active' : '' }}>
                    <div class="d-flex">
                        <div class="text-right">
                            <h5>{{ $bookingDelivery->created_at ? app('dateHelper')->formatTimestamp($bookingDelivery->created_at, 'Y-m-d') : 'N/A' }}
                            </h5>
                ...
                <li {{ $booking->status == 'accepted' ? 'class=active' : '' }}>
                    <div class="d-flex">
                        <div class="text-right">
                            <h5>{{ $bookingDelivery->accepted_at ? app('dateHelper')->formatTimestamp($bookingDelivery->accepted_at, 'Y-m-d') : 'N/A' }}
                            </h5>
                ...
                <li {{ $booking->status == 'started' ? 'class=active' : '' }}>
                    <div class="d-flex">
                        <div class="text-right">
                            <h5>{{ $bookingDelivery->start_booking_at ? app('dateHelper')->formatTimestamp($bookingDelivery->start_booking_at, 'Y-m-d') : 'N/A' }}
                            </h5>
                ...
                <li {{ $booking->status == 'in_transit' ? 'class=active' : '' }}>
                    <div class="d-flex">
                        <div class="text-right">
                            <h5>{{ $bookingDelivery->start_intransit_at ? app('dateHelper')->formatTimestamp($bookingDelivery->start_intransit_at, 'Y-m-d') : 'N/A' }}
                            </h5>
                ...
                <li {{ $booking->status == 'completed' ? 'class=active' : '' }}>
                    <div class="d-flex">
                        <div class="text-right">
                            <h5>{{ $bookingDelivery->complete_booking_at ? app('dateHelper')->formatTimestamp($bookingDelivery->complete_booking_at, 'Y-m-d') : 'N/A' }}
                            </h5>
